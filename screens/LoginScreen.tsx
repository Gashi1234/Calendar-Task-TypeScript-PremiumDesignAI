...
export default function LoginScreen({ navigation }: LoginScreenProps) {
  ...
  const animatedIconStyle = {
    // RN typing accepts Animated.Value here
  ...
  // Try biometric login on mount if user was logged in before
  useEffect(() => {
  ...
  const handleInputFocus = (inputName: FocusedInput) => {
          ...
          <View style={styles.loginCard}>
            ...
            <Animated.View style={[styles.iconContainer, animatedIconStyle]}>
              <LinearGradient colors={[colors.orange, colors.red]} style={styles.iconGradient}>
                <FontAwesome5 name="calendar-alt" size={60} color={colors.white} />
              </LinearGradient>
            </Animated.View>
            ...
            <View style={styles.inputContainer}>
              <View style={styles.inputWrapper}>
                <FontAwesome5 name="envelope" size={18} color={colors.orange} style={styles.inputIcon} />
                <TextInput
              ...
              <View style={styles.inputWrapper}>
                <FontAwesome5 name="lock" size={18} color={colors.orange} style={styles.inputIcon} />
                <TextInput
                ...
                <TouchableOpacity onPress={() => setShowPassword(!showPassword)} style={styles.eyeIcon}>
                  <FontAwesome5 name={showPassword ? 'eye-slash' : 'eye'} size={16} color={colors.orange} />
                </TouchableOpacity>
              </View>
            </View>
